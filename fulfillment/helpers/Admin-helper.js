...
function create_cards(body, session_to_use) {
    ...
    for (i = 0; i < crew.length; i++) {
        ...
        var card = new builder.HeroCard(session_to_use)
            ...
            .buttons([builder.CardAction.imBack(session_to_use, 'selected hotel details for' + body[i].UserID,'selected hotel details for' + body[i].UserID),
            builder.CardAction.imBack(session_to_use, 'selected flight details for' + body[i].UserID,'selected flight details for' + body[i].UserID)])
        cards.push(card);
    }
